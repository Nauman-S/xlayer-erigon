...
docker run --rm -p "7070:6060" -p "7071:6061" -v "$MDBX_ABSOLUTE:/mdbx_data" -v "$ROCKSDB_ABSOLUTE:/rocksdb_data" mdbx2rocksdb --mdbx /mdbx_data --rocksdb /rocksdb_data --verbose